...
export const removeRecipe = (Data) => server.post(process.env.REACT_APP_API_BASE_URL + '/recipe/removeRecipe', Data);

export const recipeMarkAsEat = (Data) => server.post(process.env.REACT_APP_API_BASE_URL + '/recipe/markAsEat', Data);
